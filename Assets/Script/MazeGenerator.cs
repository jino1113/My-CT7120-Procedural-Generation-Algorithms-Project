...
public class MazeGenerator : MonoBehaviour
{
    ...
    private Transform spawnPoint; // ตัวแปร spawnPoint ที่เป็น private
    ...
    void Start()
    {
        ...
        // ตั้งค่า spawnPoint ให้เป็นตำแหน่งของเซลล์แรก
        spawnPoint = _mazeGrid[0, 0].transform;

        // เรียกใช้ฟังก์ชัน SpawnAndSetCamera โดยใช้ spawnPoint
        SpawnAndSetCamera(_playerPrefab, spawnPoint);

        // สร้างทางออกที่เซลล์สุดท้าย (มุมตรงข้าม)
    ...
    // ฟังก์ชันที่เรียกเพื่อ spawn player และตั้งค่ากล้อง
